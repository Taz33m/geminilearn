  ...
  const renderMainTab = () => {
    ...
    if (activeTabId === "sheets") {
      return (
        <div className="p-6">
          <PanelCard>
            <SectionHeader title="Google Sheets" subtitle="Spreadsheet artifact tab" />
            <p className="text-sm text-slate-600">
              Spreadsheet artifacts will render here when generated by tools.
            </p>
          </PanelCard>
        </div>
      );
    ...
    if (activeTabId === "docs") {
      return (
        <div className="p-6">
          <PanelCard>
            <SectionHeader title="Google Docs" subtitle="Document artifact tab" />
            <p className="text-sm text-slate-600">
              Document artifacts will render here when generated by tools.
            </p>
          </PanelCard>
        </div>
      );
    ...
    if (activeTabId === "slides") {
      return (
        <div className="p-6">
          <PanelCard>
            <SectionHeader title="Google Slides" subtitle="Presentation artifact tab" />
            <p className="text-sm text-slate-600">
              Slide artifacts will render here when generated by tools.
            </p>
          </PanelCard>
        </div>
      );
